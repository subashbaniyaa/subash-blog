...
images: ["/static/blog/over-engineering-subash-dev/subash.jpeg"]
---

Read on to learn how I bootstrapped this site from template starter to the current over-engineered state. 😅
...
Hosted on [Vercel](https://vercel.com), with domain from np Domain Registration.

# Enhancements

## Blogging

We need to add CodePen to MDX components:
...
And it is done! also added a new feature, which is Real-time page view count using [PlanetScale](https://planetscale.com/) (More on this later in Guestbook section below)
...
| Line      | For devs                | [Line](https://developers.line.biz/en/docs/line-login/login-button/) |
...
The source code of this site is available on [Github](https://github.com/subashbaniyaa).
